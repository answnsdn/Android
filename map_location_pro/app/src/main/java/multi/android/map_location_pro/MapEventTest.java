...
/*
* 지도화면이 출력된 후에 이벤트(클릭, 드래그, 줌레벨)를 연결할 수 있어야 한다.
*   OnMapClickListener : 지도를 클릭할 때 발생하는 이벤트에 대한 처리
*   OnMapLongClickListener : 맵을 길게 눌렀을 때 발생하는 이벤트에 대한 처리
*   OnCameraMoveListener : 지도의 위치가 바뀌거나 줌레벨이 변경되어 카메라가 이동할 때
*                           발생하는 이벤트에 대한 처리
*   OnCameraMoveStartedListener : 지도의 위치가 바뀌거나 줌레벨이 변경되어 카메라가
...
public class MapEventTest extends AppCompatActivity implements OnMapReadyCallback ,
    ...
    public void onMapClick(LatLng latLng) {
        map.clear();
        Toast.makeText(this,"지도를 클릭했습니다 - 위도 : "+latLng.latitude+"," +
    ...
    public void onMapLongClick(LatLng latLng) {
        Toast.makeText(this,"지도를 길게 클릭했습니다 - 위도 : "+latLng.latitude+"," +
                "경도 : "+latLng.longitude,Toast.LENGTH_SHORT).show();
    }
