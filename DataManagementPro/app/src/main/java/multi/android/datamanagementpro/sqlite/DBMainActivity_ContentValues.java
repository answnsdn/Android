...
public class DBMainActivity_ContentValues extends AppCompatActivity {
    ...
    public void insert(View v){
        //컬럼에 저장할 값을 관리하는 ContentValue 이용, Map구조
        ...
        Toast.makeText(this,"ContentValue 삽입성공",Toast.LENGTH_LONG).show();
    }
    public void selectAll(View v){
        String sql = "select * from member";
        /*select 컬럼명 from 테이블명 where 조건 group by 컬럼명 having 조건 order by 컬럼명*/
        /*1. 테이블명
        * 2. 조회활 컬럼명 문자열배열
