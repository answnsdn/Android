...
public class MyAdapeter2 extends ArrayAdapter<User> {
    ...
    public MyAdapeter2(Context context, int resId, ArrayList<User> datalist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){//convertView가 null일 때만 인플레이터를 새로 만듬
